...
contract Game {
    ...
    function bet(int256 _choice) public payable notTossed {
        ...
        if (_choice == 0) tailBets += msg.value;
        else headBets += msg.value;
    ...
    function flipCoin() public restricted notTossed returns (uint256) {
    ...
    function endGame() external payable notTossed {
